    ...
    <footer className='max-container'>
      <div className='flex justify-between items-start gap-20 flex-wrap max-lg:flex-col'>
        <div className='flex flex-col items-start'>
          ...
          <p className='mt-6 text-base leading-7 text-white font-montserrat sm:max-w-sm'>Get shoes ready for the new term at your nearest Nike store. 
              ...
              <div>
                ...
                <ul>
                  {section.links.map((link)=>(
                    <li className='mt-3 text-white font-montserrat text-base  cursor-pointer hover:text-slate-gray'>
                      <a href='/'>{link.name}</a>
                    </li>
                  ))}
                </ul>
